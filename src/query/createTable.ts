...
`INSERT INTO "Recipe" ("id","name","preparation")
VALUES (1, 'Mate Manzanilla', 'Hervir una taza de agua a fuego medio por unos 4 minutos;\n bajar del fuego. Poner el agua en una taza y añadir las hojas de nilla al agua hirviendo. Tapar la infusión y dejar reposar durante 3 o 4 minutos. Colar y beber.'),
(2, 'Receta 2', 'Caliente el agua en una cacerola pequeña hasta que hierva. Apague el fuego y añada flores de manzanilla. Empapado durante 5 minutos. Colar las flores de manzanilla con un colador de malla fina y verter la infusión caliente en la taza con miel y alcohol.');`,
